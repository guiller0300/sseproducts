        ...
        >
          <b-input-group size="sm">
            ...
            <b-input-group-append>
              <b-button :disabled="!precio" @click="filter = ''">Borrar</b-button>
            </b-input-group-append>
          </b-input-group>
        </b-form-group>
  <div>
  ...
  export default {
    data() {
      return {
        ...
        items: [{name: {key: "id", sortable: true}},
    ...
    methods: {
      ...
      setupStream(){
        if(this.precio == null) {
          ...
          this.productos.push({id:createData.id,
                          description:createData.description,
                          price:createData.price});
        })
        }else{
          let esSpecific = new EventSource("http://localhost:8091/product/streams?maxPrice="+this.precio)
